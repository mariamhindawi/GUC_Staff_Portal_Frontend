...
const CourseSlotFormUpdate = props => {
    ...
    const handleSubmit = values => {
        ...
        axios({
            method: "put",
            url: `/cc/update-course-slot/${props.courseSlot.day}/${props.courseSlot.slotNumber}/${props.courseSlot.room}/${props.courseSlot.course}`,
            headers: {
                token: sessionStorage.getItem("token")
            },
            data: {
                updatedDay: values.day,
                updatedSlotNumber: values.slotNumber,
                updatedRoom: values.room,
                updatedCourse: values.course,
                updatedType: values.type
            }
        })
            .then(response => {
                setErrorMessage("");
            ...
            >
                {formikProps => (
                    <Form>
                        ...
                        <div>
                            <button type="submit">Update Course Slot</button>
                        </div>
...
export default CourseSlotFormUpdate;