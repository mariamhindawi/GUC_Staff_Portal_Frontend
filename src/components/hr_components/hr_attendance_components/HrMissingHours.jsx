        ...
        <>
          <div className="attendance-container">
            <div className="attendance-button-container">
              ...
              <div>
                <Button className="hr-attendance-button hr-view-attendance-button" onClick={() => { fetchMissingHours(); setFirstRender(false); }}>
                  View Staff
                </Button>
              </div>
            </div>
